...
btnCriar.addEventListener('click', function () {
  ...
  axios.post('/dashboard/admin/save', {
    ...
    email: email,
    empresa: empresa,
    nmrEscritorio: nmrEscritorio,
    nmrTelemovel: nmrTelemovel,
    nmrCasa: nmrCasa,
    usaNmrTelemovel: usaNmrTelemovel,
    usaNmrTlfEscrt: usaNmrTlfEscrt,
    tipo: tipo,
    grupo: grupo,
    favorito: favorito,
    notas: notas
...
AllbtnEliminar.forEach(function (elemento) {
  elemento.addEventListener('click', function () {
    var rota = this.getAttribute('rota');
    var removerElemento = document.getElementById('linha_' + this.getAttribute('data-id'));
...
var formEditar = document.querySelectorAll('.form-modal-editar');
formEditar.forEach(function (elemento) {
  elemento.addEventListener('submit', function (event) {
    event.preventDefault();
    var rotaUpdate = this.getAttribute('action');
...
var btnWebServices = document.querySelector('#WebServicesGuardar');
btnWebServices.addEventListener('click', function () {
  var hlGestURLinput = document.querySelector('#hlGestURLinput').value;
  var primaveraURLinput = document.querySelector('#primaveraURLinput').value;
  var phcURLinput = document.querySelector('#phcURLinput').value;
  var hlGestURLcheckbox = document.querySelector('#hlGestURLcheckbox');
  var primaveraURLcheckbox = document.querySelector('#primaveraURLcheckbox');
  var phcURLcheckbox = document.querySelector('#phcURLcheckbox');
  var freqAtualizacoesSelect = document.querySelector('#freqAtualizacoesSelect').value;
  ...
  axios.post('/dashboard/admin/webservices/save', {
    hlGestURLinput: hlGestURLinput,
    primaveraURLinput: primaveraURLinput,
    phcURLinput: phcURLinput,
    hlGestURLcheckbox: hlGestURLcheckbox,
    primaveraURLcheckbox: primaveraURLcheckbox,
    phcURLcheckbox: phcURLcheckbox,
    freqAtualizacoesSelect: freqAtualizacoesSelect
  }).then(function (response) {
    console.log(response);
    window.location.reload();
  })["catch"](function (error) {
...
btnAbrirWebServices.addEventListener('click', function () {
  var rotaa = this.getAttribute('rotaa');
  var hlGestURLinput = document.querySelector('#hlGestURLinput');
  var primaveraURLinput = document.querySelector('#primaveraURLinput');
  var phcURLinput = document.querySelector('#phcURLinput');
  var hlGestURLcheckbox = document.querySelector('#hlGestURLcheckbox');
  var primaveraURLcheckbox = document.querySelector('#primaveraURLcheckbox');
  var phcURLcheckbox = document.querySelector('#phcURLcheckbox');
  var freqAtualizacoesSelect = document.querySelector('#freqAtualizacoesSelect');
...
var btnExportDefinicions = document.querySelector('#ExportDefinicionsGuardar');
btnExportDefinicions.addEventListener('click', function () {
  var yealink_name = document.querySelector('#yealink_name').value;
  var yealink_directory = document.querySelector('#yealink_directory').value;
  var microsip_name = document.querySelector('#microsip_name').value;
  var microsip_directory = document.querySelector('#microsip_directory').value;
  var grandstream_name = document.querySelector('#grandstream_name').value;
  var grandstream_directory = document.querySelector('#grandstream_directory').value;
  var gigaset_name = document.querySelector('#gigaset_name').value;
  var gigaset_directory = document.querySelector('#gigaset_directory').value;
  axios.post('/dashboard/admin/exportdefinicion/save', {
    yealink_name: yealink_name,
    yealink_directory: yealink_directory,
    microsip_name: microsip_name,
    microsip_directory: microsip_directory,
    grandstream_name: grandstream_name,
    grandstream_directory: grandstream_directory,
    gigaset_name: gigaset_name,
    gigaset_directory: gigaset_directory
  }).then(function (response) {
    console.log(response);
    window.location.reload();
  })["catch"](function (error) {
...
btnAbrirExportDefinicion.addEventListener('click', function () {
  var rota = this.getAttribute('rotaExportDefinicion');
  var yealink_name = document.querySelector('#yealink_name');
  var yealink_directory = document.querySelector('#yealink_directory');
  var microsip_name = document.querySelector('#microsip_name');
  var microsip_directory = document.querySelector('#microsip_directory');
  var grandstream_name = document.querySelector('#grandstream_name');
  var grandstream_directory = document.querySelector('#grandstream_directory');
  var gigaset_name = document.querySelector('#gigaset_name');
  var gigaset_directory = document.querySelector('#gigaset_directory');
...
hlgestDropdown.addEventListener('click', function () {
  ...
  axios.get('/dashboard/admin/webservices/edit').then(function (response) {
    ...
    axios.post(rotaHlgest, {
      hlgestLink: hlgestLink
    }).then(function (response) {
      console.log(response);
      window.location.reload();
    });
...
primaveraDropdown.addEventListener('click', function () {
  ...
  axios.get('/dashboard/admin/webservices/edit').then(function (response) {
    ...
    axios.post(rotaPrimavera, {
      primaveraLink: primaveraLink
    }).then(function (response) {
      window.location.reload();
      console.log(response);
    });
...
allModal.forEach(function (element) {

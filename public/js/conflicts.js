...
btnConflictTelefone.forEach(function (elemento) {
  elemento.addEventListener('click', function () {
    var rotaConflictsTelefone = this.getAttribute('rotaConflictsTelefone');
...
btnConflictTelemovel.forEach(function (elemento) {
  elemento.addEventListener('click', function () {
    var rotaConflictsTelemovel = this.getAttribute('rotaConflictsTelemovel');
